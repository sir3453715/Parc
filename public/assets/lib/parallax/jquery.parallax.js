...
var Parallax = function () {
  ...
  _createClass(Parallax, [{
    ...
    value: function render() {
      ...
      this.$m.css({
        transform: 'translate3d(' + options.mirrorLeft + 'px, ' + Math.round(options.mirrorTop - overScroll) + 'px, 0px)',
      ...
      this.$s.css({
        transform: 'translate3d(' + options.offsetLeft + 'px, ' +  Math.round(options.offsetTop) + 'px, 0px)',
        position: 'absolute',
