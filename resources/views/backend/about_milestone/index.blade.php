        ...
        <div class="col-md-12">
            <div class="panel panel-dark">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel-title">管理大事紀 Manage Milestone</div>
                        </div>
                        <div class="col-md-6" style="text-align: right">
                            <a class="btn btn-darkblue btn-xs" href="{{ url('backend/about_milestone/order') }}"><strong>順序 Order</strong></a>
                            <a class="btn btn-success btn-xs" href="{{ url('backend/about_milestone/create') }}"><strong>新增 Create</strong></a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr >
                                    ...
                                    <td style="text-align: right">
                                        <form method="post" action="{{ url('/backend/about_milestone/delete/'.$data->id) }} ">
                                            <a class="btn btn-xs btn-success" href="{{ url('/backend/about_milestone/edit/'.$data->id) }}">編輯</a>
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
