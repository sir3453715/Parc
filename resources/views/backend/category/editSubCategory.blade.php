...
@section('content')
	<div class="row">
		<div class="col-lg-12">
			<form id="EditForm" enctype="multipart/form-data" class="form-horizontal" method="post" action="/backend/category/sub_category/edit/{{$sub_category->id}}">
				{{ csrf_field() }}
							...
							<table class="table" cellspacing="0" id="DetailsView1" style="border-collapse:collapse;">
								<tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="id" type="hidden" value="{{ $sub_category->id }}" id="serno" />
                                            {{ $sub_category->id }}
                                        </td>
                                    </tr>
                                    <!-- 欄位：active -->
									<tr>
                                        ...
                                        <td>
                                            <div class="col-lg-3 nopadding">
                                                <input name="active" type="checkbox" id="active" class="form-control" {{($sub_category->active == 1) ? "checked" : "" }}>
									...
									<tr>
										...
										<td>
											<div class="col-lg-3 nopadding">
													<input name="name" type="text" value="{{ $sub_category->name }}"  id="name" class="form-control">
									...
									<tr>
                                        ...
                                        <td>
                                            <div class="col-lg-3 nopadding">
                                                    <input name="en_name" type="text" value="{{ $sub_category->en_name }}"  id="en_name" class="form-control">
									...
									<tr>
										...
										<td>
											<div class="col-lg-3 nopadding">
											<input type="number" id="sub_order" name="sub_order" form="EditForm" value="{{$sub_category->order}}">
												<label class="error" for="sub_order"></label>
											</div>
										</td>
									</tr>                                                                                                 
									<!-- 欄位：time -->                                    
