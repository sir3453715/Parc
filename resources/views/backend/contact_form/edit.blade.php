...
@section('content')
	<div class="row">
		<div class="col-xl-12">
			<form id="EditForm" enctype="multipart/form-data" class="form-horizontal" method="post" action="/backend/contact_form/edit/{{$datas->id}}">
				{{ csrf_field() }}
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h4 class="panel-title">編輯聯絡名單 Edit Contact Form</h4>
					</div>
							...
							<table class="table" cellspacing="0" id="DetailsView1" style="border-collapse:collapse;">
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="col-lg-3 nopadding">
													<input name="name" type="text" value="{{ $datas->name }}"  id="name" class="form-control">
									...
									<tr>
										...
										<td>
											<div class="col-lg-8 nopadding">
												<input name="email" type="text" id="email" class="form-control" value="{{ $datas->email }}">
									...
									<tr>
										...
										<td>
											<div class="col-lg-8 nopadding">
												<input name="phone" type="text" id="phone" class="form-control" value="{{ $datas->phone }}">
									...
									<tr>
										...
										<td>
											<div class="col-lg-8 nopadding">
												<textarea rows="8" name="body" type="text" id="body" class="form-control">{!! $datas->body !!}</textarea>
