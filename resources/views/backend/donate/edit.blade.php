			...
			<form id="EditForm" enctype="multipart/form-data" class="form-horizontal" method="post" action="/backend/donate/edit/{{$donate->id}}">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h4 class="panel-title">編輯捐款 Edit Donation</h4>
					</div>
						...
						<div>
							...
							<table class="table" cellspacing="0" id="DetailsView1" style="border-collapse:collapse;">
								<tbody>
                                    ...
                                    <!-- 欄位：Email -->
									<tr>
										<td class="header-require col-lg-2">電子信箱<br/>Email</td>
										<td>
											<div class="col-lg-3 nopadding">
                                    ...
                                    <!-- 欄位：Phone -->
									<tr>
										<td class="header-require col-lg-2">電話<br/>Phone</td>
										<td>
											<div class="col-lg-3 nopadding">
                                    ...
                                    <!-- 欄位：Transaction time -->
									<tr>
										<td class="header-require col-lg-2">入款日期<br/>Transaction Time</td>
										<td>
											<div class="col-lg-3 nopadding">
                                    ...
                                    <!-- 欄位：ReceiptID -->
									<tr>
										<td class="header-require col-lg-2">收據編號<br/>ReceiptID</td>
										<td>
											<div class="col-lg-3 nopadding">
                                    ...
                                    <!-- 欄位：Amount -->
									<tr>
										<td class="header-require col-lg-2">金額<br/>Amount</td>
										<td>
											<div class="col-lg-3 nopadding">
...
@section('extjs')
	...
	$(document).ready(function() {
		...
		$("#btnBackTo2").click(function() {
			location.href='{{ url('backend/donate') }}';
		});
