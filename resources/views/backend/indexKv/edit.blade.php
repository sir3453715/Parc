								...
								<tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-lg-4 nopadding">
                                                ...
                                                <textarea rows="8" name="body" id="body" class="form-control" placeholder="建議56字以內">{{ $datas["indexKV"]->body }}</textarea>
                                            </div>
                                        </td>
                                    </tr>
									@endif    
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-lg-4 nopadding">
                                                <label class="body" for="body"></label>
                                                <textarea rows="8" name="body" id="body" class="form-control" placeholder="字數最多80字">{{ $datas["indexKV"]->body }}</textarea>
                                            </div>
                                        </td>
									</tr>
									@endif
