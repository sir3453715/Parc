...
@section('content')
	<div class="row">
		<div class="col-lg-12">
			<form id="form_order" class="form-horizontal" method="post" action="/backend/lecturer/order">
				{{ csrf_field() }}
                                                    ...
                                                    <div class="form-group">
														<ul id="example" class="list-group">
															@foreach($datas as $data)
																<li id="{{$data->id}}" class="list-group-item list-group-item-light">{{$data->name}}</li>
															@endforeach
														</ul>
