...
@section('title')
<title>病人自主研究中心 | Patient Autonomy Research Center - 課程與資源 - 知識工具/下載</title>
@endsection
@section('main')
<!--main-->
<main class="container">
    ...
    <ol class="breadcrumb container">
        ...
        <li class="breadcrumb-item">
            <a href="{{ url('/event/lohas/video')}}" title="知識工具/下載" tabindex="2">知識工具/下載</a>
        </li>
    ...
    <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link" id="nav-{{ $category->en_name }}" href="{{ url('event/lohas/'.$category->en_name) }}" title="{{ $category->name }}">{{$category->name}}</a>
        </li>
        @endforeach
    </ul>
