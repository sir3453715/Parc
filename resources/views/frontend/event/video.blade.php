...
@section('title')
<title>病人自主研究中心 | Patient Autonomy Research Center - 課程與資源 - 線上影音課程</title>
@endsection
@section('main')
<!--main-->
<main class="container">
    ...
    <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link" id="nav-{{ $category->en_name }}" href="{{ url('event/video/'.$category->en_name) }}" title="{{ $category->name }}">{{$category->name}}</a>
        </li>
        @endforeach
    </ul>
