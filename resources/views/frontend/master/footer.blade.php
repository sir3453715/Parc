...
<footer class="footer text-center text-lg-left" data-spy="affix" data-offset-top="100">
    <div class="container footer-more">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-5 footer-copyright">
            ...
            <div class="col-12 col-lg-3 text-center">
                ...
                <a href="https://www.facebook.com/parc.tw/" target="_blank" title="facebook(另開視窗)" class="footer-FB" rel="noopener noreferrer" >
                    <img src="{{ asset('assets/images/icon/FB_bar.png') }}" class="img-fluid" alt="social facebook" rel="noopener noreferrer" />
                </a>
            </div>
        </div>
    </div>
